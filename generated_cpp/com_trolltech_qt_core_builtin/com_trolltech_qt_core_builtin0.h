...
public slots:
   ...
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Alignment  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::DockWidgetAreas  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::DropActions  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ImageConversionFlags  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::InputMethodHints  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::InputMethodQueries  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ItemFlags  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::KeyboardModifiers  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::MatchFlags  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::MouseButtons  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Orientations  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ScreenOrientations  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TextInteractionFlags  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ToolBarAreas  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TouchPointStates  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::WindowStates  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::WindowFlags  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ApplicationAttribute  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ApplicationState  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ArrowType  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::AspectRatioMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Axis  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::BGMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::BrushStyle  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::CaseSensitivity  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::CheckState  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ClipOperation  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ConnectionType  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ContextMenuPolicy  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Corner  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::CursorMoveStyle  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::CursorShape  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::DateFormat  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::DayOfWeek  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::DockWidgetArea  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::DropAction  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Edge  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::FillRule  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::FocusPolicy  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::FocusReason  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::GestureState  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::GestureType  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::GlobalColor  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::InputMethodHint  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::InputMethodQuery  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ItemDataRole  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ItemSelectionMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Key  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::LayoutDirection  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::MaskMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::MouseEventFlag  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::MouseEventSource  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::NativeGestureType  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::Orientation  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::PenCapStyle  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::PenJoinStyle  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::PenStyle  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ScreenOrientation  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ScrollBarPolicy  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ScrollPhase  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ShortcutContext  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::SizeHint  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::SizeMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::SortOrder  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TextElideMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TextFormat  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TextInteractionFlag  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TimeSpec  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TimerType  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ToolBarArea  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::ToolButtonStyle  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::TransformationMode  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::WidgetAttribute  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::WindowModality  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::WindowState  arg__1);
   const QMetaObject*  static_Qt_qt_getEnumMetaObject(Qt::WindowType  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Alignment  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::DockWidgetAreas  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::DropActions  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ImageConversionFlags  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::InputMethodHints  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::InputMethodQueries  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ItemFlags  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::KeyboardModifiers  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::MatchFlags  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::MouseButtons  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Orientations  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ScreenOrientations  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TextInteractionFlags  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ToolBarAreas  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TouchPointStates  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::WindowStates  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::WindowFlags  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ApplicationAttribute  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ApplicationState  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ArrowType  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::AspectRatioMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Axis  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::BGMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::BrushStyle  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::CaseSensitivity  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::CheckState  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ClipOperation  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ConnectionType  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ContextMenuPolicy  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Corner  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::CursorMoveStyle  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::CursorShape  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::DateFormat  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::DayOfWeek  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::DockWidgetArea  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::DropAction  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Edge  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::FillRule  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::FocusPolicy  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::FocusReason  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::GestureState  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::GestureType  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::GlobalColor  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::InputMethodHint  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::InputMethodQuery  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ItemDataRole  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ItemSelectionMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Key  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::LayoutDirection  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::MaskMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::MouseEventFlag  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::MouseEventSource  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::NativeGestureType  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::Orientation  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::PenCapStyle  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::PenJoinStyle  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::PenStyle  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ScreenOrientation  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ScrollBarPolicy  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ScrollPhase  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ShortcutContext  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::SizeHint  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::SizeMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::SortOrder  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TextElideMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TextFormat  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TextInteractionFlag  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TimeSpec  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TimerType  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ToolBarArea  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::ToolButtonStyle  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::TransformationMode  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::WidgetAttribute  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::WindowModality  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::WindowState  arg__1);
   const char*  static_Qt_qt_getEnumName(Qt::WindowType  arg__1);
};
